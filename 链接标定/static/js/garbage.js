...
(function (e, t) {
    ...
    e.ui = e.ui || {}, e.extend(e.ui, {
        ...
        disableSelection: function () {
            return this.bind((e.support.selectstart ? "selectstart" : "touchstart") + ".ui-disableSelection", function (e) {
                e.preventDefault()
            })
...
(function (e) {
    ...
    e(document).bind('touchend',function () {
        ...
        _mouseDestroy: function () {
            this.element.unbind("." + this.widgetName), this._mouseMoveDelegate && e(document).unbind("touchmove", this._mouseMoveDelegate).unbind("touchend", this._mouseUpDelegate)
        },
        _mouseDown: function (i) {
            if (!t) {
                console.log('mouse downnnnnnnn')
...
console.log('_mouseMoveDelegate')
                    return s._mouseMove(e)
                }, this._mouseUpDelegate = function (e) {
                    return s._mouseUp(e)
                },console.log(e), e(document).bind("mouseenter", this._mouseMoveDelegate).bind("touchend", this._mouseUpDelegate), i.preventDefault(), t = !0, !0)) : !0
            }
        },
        ...
        _mouseUp: function (t) {
            return e(document).unbind("touchmove", this._mouseMoveDelegate).unbind("touchend", this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && e.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), !1
        },
